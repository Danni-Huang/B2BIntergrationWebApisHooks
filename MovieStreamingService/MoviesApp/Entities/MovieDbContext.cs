        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Movie>().HasData(
                new Movie() { 
                    ...
                    ClaimUrl = "https://localhost:7082/api/streamingrights/notification/1"
                },
                new Movie() {
                    MovieId = 2,
                    Name = "Apocalypse Now",
                    ...
                    StreamingStatus = "ActivelyStreaming",
                    ClaimUrl = "https://localhost:7082/api/streamingrights/notification/4"
                },
                new Movie() {
                    MovieId = 3,
                    Name = "Annie Hall",
                    ...
                    StreamingStatus = "ActivelyStreaming",
                    ClaimUrl = "https://localhost:7082/api/streamingrights/notification/3"
                }
            );
        }
    }
